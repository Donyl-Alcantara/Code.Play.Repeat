...
original_map = pygame.image.load("pixel_philippines_map.png").convert_alpha()
...
# Fonts
try:
    main_font = pygame.font.Font("pixel_font.ttf", 18)
    small_font = pygame.font.Font("pixel_font.ttf", 14)
    title_font = pygame.font.Font("pixel_font.ttf", 24)
    instruction_font = pygame.font.Font("pixel_font.ttf", 8)  # New font for instructions
except:
